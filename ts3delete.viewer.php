		...
		<footer id="footer">
			<div class="container">
				<p class="text-muted credit">
					Powered by <a href="http://php.net">php</a> &amp; <a href="http://dev.mysql.com">MySQL</a> &amp; <a href="http://ts3admin.info">ts3admin.class</a><br>
					Created by <a href="http://hoshinoa.me">k725</a>
				</p>
			</div>
		</footer>
